...
idelay =  -22#-13 #-13 #-23 for flattop 21/9	 #-22#-22 #-21	 #-20, -26 #apply this delay to rf zerocrossing time
...
def frequency_analysis(data, Qs, sync_bin):
	...
	plt.plot(phase_m_deg, Qs_amp,'r',label=r'linear $Q(\phi)$, '+str(V_rf)+' kV')
	plt.plot(phase_file, Qs_amp_num,'ro',label=r'tracking $Q(\phi)$, '+str(V_rf)+' kV')
