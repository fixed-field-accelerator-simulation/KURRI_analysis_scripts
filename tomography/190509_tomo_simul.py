...
import tomo_defs_190509 as tdefs
import time
...
if generate_dist:
	...
	if calculate_H_period:
		...
		Ts_amp_a, J_a = tdefs.synchrotron_period_vs_amplitude(ph_a_left, phi_s, a1, a2, phase_sep[-1], harmonic, omegarev, eta, n_l, coef_l, ang_l)
